      ...
      <ScrollView
        ...
        <View className="flex-1 px-5 pb-8 pt-3">
          ...
          <View className="rounded-[28px] bg-white">
            ...
            <View className="mb-4">
              <Text className="mb-2 text-sm font-semibold text-slate-700">Service principal</Text>
              <TextInput
          ...
          <TouchableOpacity onPress={() => router.replace('/provider')} className="mt-6 self-center">
